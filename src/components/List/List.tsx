...
export default function List() {
  ...
  const { jettonsData, getJettons } = useTokens();
  ...
  return (
    <section className={styles["jettons-section"]}>
            ...
            return (
              <div key={index} className={styles["jettons-tokens__item-block"]}>
                ...
                <div className={styles["jettons-tokens__item-balance"]}>
                  ...
                  <div className={styles["jettons-tokens__item-balance-usdBlock"]}>
                    <span
                      className={styles["jettons-tokens__item-balance-usd"]}
                    >
                      ${el.usdBalance}
                    </span>
                    <span
      ...
      <div>
        ...
        <div>тут мапятся стейкинг если их несколько</div>
      </div>
    </section>
  );
}
